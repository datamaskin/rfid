...
//       BlueZ.removeServiceByID(0x00010004l);
   ...
   private void jbInit() throws Exception {
     ...
     int i=-1;
     c.fill = GridBagConstraints.HORIZONTAL; c.gridx=++i;c.gridy=0;c.anchor=GridBagConstraints.WEST;c.weightx=1;c.weighty=0;c.gridwidth=3;
     clSer.add(statusPanel, c);
     c.gridy=++i; c.gridwidth = 1; c.fill = GridBagConstraints.NONE;
